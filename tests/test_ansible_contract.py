...
class AnsibleLayoutTests(unittest.TestCase):
    def test_operational_python_collector_is_removed(self) -> None:
        ...
        allowed_action_plugins = {
            ...
            Path("ansible/plugins/action/reactive_resume_dev_argocd_registration_guarded_k8s.py"),
    ...
    def test_minimal_ansible_layout_exists(self) -> None:
        required = [
            ...
            "bin/bootstrap-keycloak-dev-identity",
            "playbooks/bootstrap_keycloak_dev_identity.yml",
            "plugins/action/keycloak_dev_identity_guarded.py",
            "roles/keycloak_dev_identity_bootstrap/defaults/main.yml",
            "roles/keycloak_dev_identity_bootstrap/tasks/main.yml",
            "bin/bootstrap-keycloak-dev-identity-transition",
            ...
            "files/policies/reactive-resume-dev-argocd-handoff/ingress-private.yaml",
            "files/policies/reactive-resume-dev-argocd-handoff/migration-job.yaml",
            "files/policies/reactive-resume-dev-argocd-handoff/networkpolicy-default-deny.yaml",
            "files/policies/reactive-resume-dev-argocd-handoff/networkpolicy-egress.yaml",
            "files/policies/reactive-resume-dev-argocd-handoff/networkpolicy-route-allow-traefik.yaml",
            "files/policies/reactive-resume-dev-argocd-handoff/service.yaml",
            "files/policies/reactive-resume-dev-argocd-handoff/serviceaccount.yaml",
            "files/components/reactive-resume-dev-argocd-registration/config/application-reactive-resume-dev.yaml",
            "files/components/reactive-resume-dev-argocd-registration/config/appproject-reactive-resume-dev.yaml",
            "files/components/reactive-resume-dev-argocd-registration/config/secret-cluster-reactive-resume-dev.yaml",
            "files/components/reactive-resume-dev-argocd-registration/rbac/role-argocd-application-controller-reactive-resume-dev.yaml",
            "files/components/reactive-resume-dev-argocd-registration/rbac/rolebinding-argocd-application-controller-reactive-resume-dev.yaml",
            "files/components/reactive-resume-dev-tls/MANIFESTS.sha256",
            "files/components/reactive-resume-dev-tls/RBAC.sha256",
            "files/components/reactive-resume-dev-tls/source/reactive-resume-dev-tls.yaml",
            "files/components/reactive-resume-dev-tls/rbac/infisical-writer-role.yaml",
            "files/components/reactive-resume-dev-tls/rbac/infisical-writer-rolebinding.yaml",
            ...
            "bin/bootstrap-infisical-reactive-resume-dev-ca",
            ...
            "playbooks/bootstrap_infisical_reactive_resume_dev_ca.yml",
            ...
            "plugins/action/infisical_reactive_resume_dev_ca_guarded_k8s.py",
            ...
            "roles/infisical_reactive_resume_dev_ca_bootstrap/defaults/main.yml",
            "roles/infisical_reactive_resume_dev_ca_bootstrap/tasks/main.yml",
            ...
            "files/backup/cristexweb-opentofu-github-state-backup.service",
            ...
            "bin/bootstrap-cristexhub-prod-registration",
            ...
            "plugins/action/cristexhub_prod_registration_guarded_k8s.py",
            ...
            "roles/cristexhub_prod_registration/defaults/main.yml",
            "roles/cristexhub_prod_registration/tasks/main.yml",
            ...
            "roles/reactive_resume_dev_soak/defaults/main.yml",
            "roles/reactive_resume_dev_soak/tasks/main.yml",
            "roles/reactive_resume_dev_soak/tasks/sample.yml",
            "playbooks/soak_reactive_resume_dev.yml",
            "bin/soak-reactive-resume-dev",
        ...
        required.extend(
            [
                ...
                "bin/bootstrap-argocd-target-cache-repair",
                ...
                "library/cristexhub_prod_mongodb_networkpolicy_selector.py",
                ...
                "files/components/rabbitmq-prod-credential-rotation/SOURCE-CLOSURE.sha256",
