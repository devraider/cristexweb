...
class InfisicalOperatorCandidateProvenanceContractTests(unittest.TestCase):
    ...
    def test_namespace_rbac_secret_zero_and_compatibility_blockers_are_explicit(self) -> None:
        ...
        for required in (
            ...
            "check and separately approved first apply passed",
            "idempotence and all Operator checkpoints remain separately approved and **NOT RUN**",
            ...
            "Runtime approvals",
            "foundation Namespace check and first apply are complete",
