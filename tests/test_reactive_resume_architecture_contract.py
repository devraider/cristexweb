...
class ReactiveResumeArchitectureContractTests(unittest.TestCase):
    ...
    def test_no_executable_source_or_secret_value_is_added(self) -> None:
        ...
        approved_backup_sources = {
            ...
            ROOT / "ansible/bin/configure-reactive-resume-dev-tls-renewal",
            ROOT / "ansible/playbooks/configure_reactive_resume_dev_tls_renewal.yml",
            ROOT / "ansible/roles/reactive_resume_dev_tls_renewal/defaults/main.yml",
            ROOT / "ansible/roles/reactive_resume_dev_tls_renewal/tasks/main.yml",
            ...
            ROOT / "ansible/files/components/reactive-resume-dev-tls/renewal/reactive-resume-dev-tls-renew",
        ...
        for approved_root in (
            ...
            ROOT / "ansible/files/components/reactive-resume-object-storage-history",
        ...
        approved_backup_sources.update(
            {
                ...
                ROOT / "ansible/bin/check-reactive-resume-object-storage-source",
                ROOT / "ansible/playbooks/bootstrap_reactive_resume_dev_argocd_alignment.yml",
                ROOT / "ansible/playbooks/check_reactive_resume_object_storage_source.yml",
                ROOT / "ansible/roles/reactive_resume_object_storage_source_check/defaults/main.yml",
                ROOT / "ansible/roles/reactive_resume_object_storage_source_check/tasks/main.yml",
