        ...
        self.assertEqual(
            {
                ...
                "coredns-external-forwarding.md",
                "cristexhub-dev-argocd-registration.md",
                ...
                "infisical-cristexhub-dev-runtime-materialization.md",
                ...
                "reactive-resume-dev-argocd-alignment.md",
                "reactive-resume-dev-tls-renewal.md",
                "infisical-reactive-resume-dev-ca-materialization.md",
                ...
                "shared-mongodb-networkpolicy-bootstrap.md",
