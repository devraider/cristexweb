...
class ReactiveResumeDevArgoRegistrationContractTests(unittest.TestCase):
    ...
    def test_hash_bound_guarded_entrypoint_and_runbook(self):
        ...
        self.assertIn('reactive_resume_dev_argocd_registration_desired_state_sha256', tasks)
        self.assertIn('reactive_resume_dev_argocd_registration_destination_policy_sha256', tasks)
        self.assertIn('item.stat.checksum == expected_alignment_hashes[alignment_index]', tasks)
