...
image/identities/path/schedule/retention/RPO/RTO remain unselected or unproved.
`shared-services` check/apply/idempotence remains separately approved and **NOT RUN**.
