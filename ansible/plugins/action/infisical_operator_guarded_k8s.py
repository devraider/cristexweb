...
_EXPECTED_OBJECT_HASHES = {
    ...
    ('admissionregistration.k8s.io/v1', 'ValidatingAdmissionPolicy', '', 'infisical-connection-boundary'): '336075ae68fbf29fd8c4b8192ab33636adb011855a1667b585881e6d9600597a',
