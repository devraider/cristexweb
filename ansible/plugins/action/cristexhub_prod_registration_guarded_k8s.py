...
EXPECTED_HASHES: dict[tuple[str, str, str, str], str] = {('argoproj.io/v1alpha1', 'AppProject', 'argocd', 'cristexhub-prod'): '2446878c1d8a631c138625854078d19c90c401233dc68c5e1e0ba2f75d164cac',
 ('argoproj.io/v1alpha1', 'Application', 'argocd', 'cristexhub-prod'): '66d7321471ab2144065cebb6e9e1ba3d5b3c929615015bd52eef05804a3b96f9',
