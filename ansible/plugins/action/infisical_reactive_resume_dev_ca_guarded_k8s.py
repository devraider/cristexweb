...
EXPECTED: dict[tuple[str, str, str, str], str] = {
    ...
    ('admissionregistration.k8s.io/v1', 'ValidatingAdmissionPolicy', '', 'reactive-resume-dev-ca-source-boundary'): 'b6ad7ddee979e50f323626cc89a7950f56eb2b75893d9634a53c33efeda648d7',
    ...
    ('admissionregistration.k8s.io/v1', 'ValidatingAdmissionPolicy', '', 'reactive-resume-dev-ca-target-boundary'): '7e0efe0d78775cb85af2ac92c22647125bd10468f6b77854ce80bd15219909ba',
