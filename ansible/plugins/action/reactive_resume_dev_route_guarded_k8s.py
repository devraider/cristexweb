...
class ActionModule(KubernetesActionModule):
    def run(self, tmp=None, task_vars=None):
        ...
        valid = valid and isinstance(binding, dict) and binding.get('attestation_sha256') == hashlib.sha256(token.encode()).hexdigest() and int(binding.get('object_count', -1)) == 2 and int(binding.get('prestate_count', -1)) == 2 and binding.get('identity_set_sha256') == '34b1f8223b7bed800fb481c74a2549e3f0c07602ecb9498d84489f1fd904d9ee' and binding.get('namespace_contract') is True and binding.get('no_delete_path') is True
