...
_EXPECTED_OBJECT_HASHES = {('apiextensions.k8s.io/v1', 'CustomResourceDefinition', '', 'applications.argoproj.io'): '6a13379ac5654bff09a1421b5b636e3e94d46be8de080b25f8df01ce4f2b494c',
 ...
 ('networking.k8s.io/v1', 'NetworkPolicy', 'argocd', 'argocd-controller-egress'): '68d6fca8e7050b77256f189218d57601d1b1190c0c185c7b5e93cc7d9e6903ae',
 ...
 ('networking.k8s.io/v1', 'NetworkPolicy', 'argocd', 'argocd-repo-server-egress'): '737dee2c412c4fe2c9e8acea20413b7612e8463b3123a840670fe0ee0916abb8',
 ...
 ('networking.k8s.io/v1', 'NetworkPolicy', 'argocd', 'argocd-server-egress'): '3ae0f3ace41e3119731ec0744fde3a659a62ed64d3a72aff5c429574cc18df15',
    ...
    def run(self, tmp: str | None = None, task_vars: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        valid_binding = (
            ...
            and binding.get("identity_set_sha256") == (
                "bb81e0babfa314a91e52479e71d778b79c81df77bf5b74a9f2cb1bf08d692b81"
            )
