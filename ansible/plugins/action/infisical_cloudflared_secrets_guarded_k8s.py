...
_EXPECTED_OBJECT_HASHES: dict[tuple[str, str, str, str], str] = {
    ...
    ('admissionregistration.k8s.io/v1', 'ValidatingAdmissionPolicy', '', 'infisical-cloudflared-secret-write-boundary'): 'a799aeea2b112629b854f19723c7e4593ee54c42470d536a545d1f07b6ab6245',
    ...
    ('admissionregistration.k8s.io/v1', 'ValidatingAdmissionPolicy', '', 'infisical-cloudflared-source-boundary'): '0a76fffecf866098afe728c52c787ad7b09a902356e5af581d0c99e06264876d',
    ...
    ('admissionregistration.k8s.io/v1', 'ValidatingAdmissionPolicy', '', 'infisical-cloudflared-static-secret-boundary'): 'ac4af39854c9df36d991661a1b9d6cd0c0efeb846c9132b97df8512c8223b12a',
